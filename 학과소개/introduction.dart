...
class CollegeIntroductionPage extends StatefulWidget {
  const CollegeIntroductionPage({Key? key}) : super(key: key);

  @override
  State<CollegeIntroductionPage> createState() => _CollegeIntroductionPageState();
}

class _CollegeIntroductionPageState extends State<CollegeIntroductionPage> {
              ...
              children: [
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    DepartmentList('AI 소프트웨어학부'),
                    DepartmentList('컴퓨터공학전공'),
                    DepartmentList('스마트보안전공'),
                    DepartmentList('전자공학전공'),
                    DepartmentList('차세대반도체전공'),
                    DepartmentList('전기공학과'),
                    DepartmentList('스마트시티융합학과'),
                    DepartmentList('의공학과'),
                    DepartmentList('에너지IT학과'),
                  ],
                )),
              ],
            ),
